=== Blog Post Filter ===
Contributors: ammar.shahraki
Donate link: http://www.sloth.ir/
Tags: filter, categories, category, frontpage, post
...
You can send an email to the ammar.shahraki@gmail.com.

== Screenshots ==

1. Preview of the Blog Post Filter's admin page (v1.0.1).
2. Preview of the Blog Post Filter's admin page (v1.1.0).
3. Persian translation of the plugin (v1.1.0).
